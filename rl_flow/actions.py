...
def default_macro_actions() -> list[MacroAction]:
    return [
        ...
        MacroAction("rewrite", ("rewrite",)),
        MacroAction("rewrite_lp", ("rewrite -l",)),
        MacroAction("rewrite_lpz", ("rewrite -l -z",)),
        MacroAction("rewrite_p12_lp", ("rewrite -P 12 -C 4 -l",)),
        MacroAction("rewrite_p12_lpz", ("rewrite -P 12 -C 4 -l -z",)),
        MacroAction("refactor", ("refactor",)),
        MacroAction("refactor_lp", ("refactor -l",)),
        MacroAction("refactor_lpz", ("refactor -l -z",)),
        MacroAction("refactor_i12_c20_lp", ("refactor -I 12 -C 20 -l",)),
        MacroAction("refactor_i8_c12_lp", ("refactor -I 8 -C 12 -l",)),
        MacroAction("lut_opt", ("lut_opt",)),
        MacroAction("lut_opt_zg", ("lut_opt -z",)),
        MacroAction("lut_opt_fast", ("lut_opt -P 12 -C 6 -G 1 -L 1",)),
        MacroAction("lut_opt_area", ("lut_opt -P 12 -C 6 -G 2 -L 3",)),
        MacroAction("lut_opt_area_zg", ("lut_opt -P 12 -C 6 -G 2 -L 3 -z",)),
        ...
        MacroAction("ref_rw", ("refactor -l", "rewrite -l -z")),
        MacroAction("lut_bal", ("lut_opt", "balance")),
        MacroAction("bal_ref", ("balance", "refactor -l")),
        MacroAction("rwz_lut", ("rewrite -l -z", "lut_opt -P 12 -C 6 -G 2 -L 3")),
        MacroAction(
            "stop_map_default",
            tuple(),
            terminal=True,
        ...
        MacroAction(
            ...
            tuple(),
            terminal=True,
            final_map_command="map_fpga -P 12 -C 4 -G 1 -L 2",
        ),
        MacroAction(
            "stop_map_hist_cut12",
            tuple(),
            terminal=True,
            final_map_command="map_fpga -P 12 -C 6 -G 1 -L 2 -t 1",
        ),
        MacroAction(
            "stop_map_hist_area",
            tuple(),
            terminal=True,
            final_map_command="map_fpga -P 12 -C 6 -G 2 -L 3 -t 1",
        ),
    ]
