...
class Tester(object):
    ...
    def run_test(self, config):
        ...
        workspace = config.get('global', 'results')
        ...
        for f in os.listdir(case_dir):
            ...
            if os.path.isdir(source):
                cases.append(source)
                cmd = f'python {os.path.dirname(os.path.realpath(__file__))}/case.py {source} {workspace} {self.config}'
        ...
        rpt_file = os.path.join(workspace, 'report.csv')
